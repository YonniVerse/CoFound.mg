...
const messages = {
    fr: {
        ...
        "onboarding.fieldsLoadError": "Impossible de charger les filières.",
        "onboarding.field.computerScience": "Informatique",
        "onboarding.field.law": "Droit",
        "onboarding.field.economics": "Économie",
        "onboarding.field.management": "Gestion",
        "onboarding.field.communication": "Communication",
        "onboarding.field.engineering": "Ingénierie",
        "onboarding.field.design": "Design",
        "onboarding.field.agriculture": "Agriculture",
        ...
        "common.identityProtected": "Identité protégée jusqu'à acceptation mutuelle",
        "common.proposeExchange": "Proposer un échange",
        ...
        "feed.projectComposerStart": "Commencer un post",
        "feed.projectComposerVideo": "Vidéo",
        "feed.projectComposerPhoto": "Photo",
        "feed.projectComposerArticle": "Rédiger un article",
        "feed.projectComposerClose": "Fermer l’éditeur",
        "feed.projectsEyebrow": "Communauté projet",
        "feed.projectsFeedTitle": "Le fil des projets",
        "feed.projectsFeedSubtitle": "Les équipes partagent leurs avancées et leurs besoins, au nom de leur projet.",
        "feed.projectComposerTitle": "Publier au nom d’un projet",
        "feed.projectComposerHint": "Choisis un projet dont tu es propriétaire pour partager une actualité avec la communauté.",
        "feed.projectComposerProjectLabel": "Projet",
        "feed.projectComposerTypeLabel": "Type de publication",
        "feed.projectComposerPlaceholder": "Partage une avancée, un besoin ou une prochaine étape…",
        "feed.projectComposerNoProject": "Crée d’abord un projet pour pouvoir publier au nom d’une équipe.",
        "feed.projectPostPublish": "Publier",
        "feed.projectPostPublishing": "Publication…",
        "feed.projectPostPublishedLabel": "Publication du projet",
        "feed.projectPostPublishedAs": "Publié au nom de",
        "feed.projectPostViewProject": "Voir le projet",
        "feed.projectPostsLoading": "Chargement du fil des projets…",
        "feed.projectPostsEmptyTitle": "Aucune publication pour le moment",
        "feed.projectPostsEmptyHint": "Les projets pourront partager ici leurs avancées et leurs besoins.",
        "feed.projectPostsLoadError": "Impossible de charger le fil des publications projet.",
        "feed.projectPostContentError": "Le contenu doit contenir entre 1 et 2 000 caractères.",
        "feed.projectPostCreateError": "La publication n’a pas pu être créée.",
    ...
    'organizationRequest.errors.rejectionReason': 'Un motif d’au moins 5 caractères est obligatoire pour refuser une demande.',
    'organizationRequest.errors.alreadyDecided': 'Cette demande a déjà été traitée.',
    'organizationRequest.errors.capabilityNotAvailable': 'Cette capacité sera activée dans une version ultérieure.',
    'organizationRequest.errors.certificationOnlyInstitution': 'La certification des affiliations est réservée aux établissements.',
    'organizationRequest.cta': 'Vous représentez une organisation ?',
    'organizationRequest.cta.link': 'Demander un accès',
    'staff.organizations.back': 'Retour à la console',
    'staff.organizations.eyebrow': 'CONSOLE STAFF',
    'staff.organizations.title': 'Organisations et capacités',
    'staff.organizations.subtitle': 'Validez les demandes d’accès et accordez les capacités une par une.',
    'staff.organizations.status': 'File',
    'staff.organizations.pending': 'En attente',
    'staff.organizations.approved': 'Approuvées',
    'staff.organizations.rejected': 'Refusées',
    'staff.organizations.empty': 'Aucune demande dans cet état.',
    'staff.organizations.contact': 'Contact',
    'staff.organizations.documents': 'Pièce(s)',
    'staff.organizations.openDocument': 'Ouvrir temporairement',
    'staff.organizations.documentError': 'Le justificatif n’a pas pu être ouvert.',
    'staff.organizations.createdAt': 'Reçue le',
    'staff.organizations.details': 'Détail de la demande',
    'staff.organizations.approve': 'Approuver et créer l’organisation',
    'staff.organizations.reject': 'Refuser la demande',
    'staff.organizations.rejectReason': 'Motif du refus',
    'staff.organizations.rejectReasonPlaceholder': 'Expliquez la décision au demandeur…',
    'staff.organizations.confirmReject': 'Confirmer le refus',
    'staff.organizations.cancel': 'Annuler',
    'staff.organizations.capabilities': 'Capacités de l’organisation',
    'staff.organizations.capabilitiesHint': 'Chaque capacité est indépendante. Son retrait peut interrompre le parcours associé.',
    'staff.organizations.certify': 'Certifier les affiliations',
    'staff.organizations.publish': 'Publier des appels à candidatures',
    'staff.organizations.recruit': 'Rechercher projets et talents',
    'staff.organizations.mvpOnly': 'V2 — non activable au MVP',
    'staff.organizations.grant': 'Activer',
    'staff.organizations.revoke': 'Retirer',
    'staff.organizations.success': 'Décision enregistrée et auditée.',
    'staff.organizations.error': 'La demande n’a pas pu être traitée.',
    'staff.organizations.capabilityError': 'La capacité n’a pas pu être modifiée.',
    'partner.projects.back': 'Retour à l’espace organisation',
    'partner.projects.eyebrow': 'ESPACE PARTENAIRE',
    'partner.projects.title': 'Découvrir des projets',
    'partner.projects.subtitle': 'Filtrez les projets recrutant et gardez vos pistes privées.',
    'partner.projects.search': 'Rechercher',
    'partner.projects.searchPlaceholder': 'Titre ou problème adressé…',
    'partner.projects.minMaturity': 'Maturité min.',
    'partner.projects.maxMaturity': 'Maturité max.',
    'partner.projects.submit': 'Appliquer les filtres',
    'partner.projects.empty': 'Aucun projet ne correspond à ces filtres.',
    'partner.projects.maturity': 'Maturité BMC',
    'partner.projects.watch': 'Suivre',
    'partner.projects.unwatch': 'Ne plus suivre',
    'partner.projects.notePlaceholder': 'Note privée…',
    'partner.projects.contact': 'Contacter l’équipe',
    'partner.projects.contactPlaceholder': 'Présentez votre intérêt en quelques lignes…',
    'partner.projects.sendContact': 'Envoyer un message',
    'partner.projects.contactSent': 'Message envoyé. Aucun second contact ne pourra être créé.',
    'partner.projects.error': 'Cette action n’a pas pu être effectuée.',
    'partner.profile.title': 'Profil organisationnel vérifié',
    'partner.profile.back': 'Retour aux projets',
    'partner.opportunities.back': 'Retour à l’espace organisation',
    'partner.opportunities.title': 'Opportunités',
    'partner.opportunities.subtitle': 'Publiez un appel et suivez les candidatures reçues.',
    'partner.opportunities.create': 'Créer une opportunité',
    'partner.opportunities.titlePlaceholder': 'Titre de l’appel',
    'partner.opportunities.descriptionPlaceholder': 'Décrivez le besoin, les critères et le déroulement…',
    'partner.opportunities.publish': 'Publier',
    'partner.opportunities.draft': 'Brouillon',
    'partner.opportunities.published': 'Publiée',
    'partner.opportunities.application': 'Candidature',
    'partner.opportunities.accept': 'Accepter',
    'partner.opportunities.reject': 'Refuser',
    'partner.opportunities.rejectPlaceholder': 'Motif du refus…',
    'partner.talents.back': 'Retour à l’espace organisation',
    'partner.talents.title': 'Trouver des talents',
    'partner.talents.subtitle': 'Explorez les profils qui ont choisi d’être visibles pour les partenaires.',
    'partner.talents.searchPlaceholder': 'Pseudonyme, compétence ou bio…',
    'partner.talents.search': 'Rechercher des talents',
    'partner.talents.empty': 'Aucun profil visible ne correspond à votre recherche.',
    'partner.talents.contact': 'Proposer un échange',
    'partner.finance.title': 'Engagement financier',
    'partner.finance.create': 'Proposer un engagement',
    'partner.finance.amount': 'Montant',
    'partner.finance.currency': 'Devise',
    'partner.finance.status': 'Statut : proposé',
    },
    'organizationRequest.backHome': "Retour à l'accueil",
    'organizationRequest.eyebrow': 'ACCÈS ORGANISATIONNEL',
    'organizationRequest.title': 'Rejoindre CoFound.mg en tant qu’organisation',
    ...
    mg: {
        ...
        "onboarding.fieldsLoadError": "Tsy azo alaina ny sampam-pianarana.",
        "onboarding.field.computerScience": "Informatika",
        "onboarding.field.law": "Lalàna",
        "onboarding.field.economics": "Toekarena",
        "onboarding.field.management": "Fitantanana",
        "onboarding.field.communication": "Fifandraisana",
        "onboarding.field.engineering": "Injeniera",
        "onboarding.field.design": "Famolavolana",
        "onboarding.field.agriculture": "Fambolena",
        ...
        "common.anonymous": "Tsy mitonona anarana",
        "common.contact": "Mifandray",
        "common.identityProtected": "Voaaro ny mombamomba azy mandra-pifanarahan’ny roa tonta",
        "common.proposeExchange": "Hanolotra fifanakalozana",
        "common.category": "Sokajy",
        "common.skills": "Fahaiza-manao",
        ...
        "feed.projectComposerStart": "Hanomboka famoahana",
        "feed.projectComposerVideo": "Lahatsary",
        "feed.projectComposerPhoto": "Sary",
        "feed.projectComposerArticle": "Hanoratra lahatsoratra",
        "feed.projectComposerClose": "Hakatona ny mpanonta",
        "feed.projectsEyebrow": "Vondron’ny tetikasa",
        "feed.projectsFeedTitle": "Ny filan’ny tetikasa",
        "feed.projectsFeedSubtitle": "Mizara ny fandrosoany sy ny filàny ny ekipa, amin’ny anaran’ny tetikasany.",
        "feed.projectComposerTitle": "Hamoaka amin’ny anaran’ny tetikasa",
        "feed.projectComposerHint": "Safidio ny tetikasa anananao mba hizara vaovao amin’ny vondrom-piarahamonina.",
        "feed.projectComposerProjectLabel": "Tetikasa",
        "feed.projectComposerTypeLabel": "Karazana famoahana",
        "feed.projectComposerPlaceholder": "Zarao ny fandrosoana, ny filàna na ny dingana manaraka…",
        "feed.projectComposerNoProject": "Mamoròna tetikasa aloha vao afaka mamoaka amin’ny anaran’ny ekipa.",
        "feed.projectPostPublish": "Havoaka",
        "feed.projectPostPublishing": "Eo am-pamoahana…",
        "feed.projectPostPublishedLabel": "Famoahan’ny tetikasa",
        "feed.projectPostPublishedAs": "Navoaka amin’ny anaran’ny",
        "feed.projectPostViewProject": "Hijery ny tetikasa",
        "feed.projectPostsLoading": "Eo am-pamakiana ny filan’ny tetikasa…",
        "feed.projectPostsEmptyTitle": "Tsy mbola misy famoahana",
        "feed.projectPostsEmptyHint": "Afaka mizara ny fandrosoany sy ny filàny eto ny tetikasa.",
        "feed.projectPostsLoadError": "Tsy azo alaina ny filan’ny famoahana tetikasa.",
        "feed.projectPostContentError": "Tokony ho eo anelanelan’ny tarehintsoratra 1 sy 2 000 ny votoaty.",
        "feed.projectPostCreateError": "Tsy azo noforonina ny famoahana.",
    ...
    'organizationRequest.errors.rejectionReason': 'Ilaina ny antony misy tarehintsoratra 5 farafahakeliny raha mandà fangatahana.',
    'organizationRequest.errors.alreadyDecided': 'Efa nokarakaraina ity fangatahana ity.',
    'organizationRequest.errors.capabilityNotAvailable': 'Hampiasaina amin’ny kinova manaraka ity fahafahana ity.',
    'organizationRequest.errors.certificationOnlyInstitution': 'Ny sekoly na oniversite ihany no afaka manamarina affiliations.',
    'organizationRequest.cta': 'Misolo tena fikambanana ve ianao?',
    'organizationRequest.cta.link': 'Mangataka fidirana',
    'staff.organizations.back': 'Hiverina any amin’ny console',
    'staff.organizations.eyebrow': 'CONSOLE STAFF',
    'staff.organizations.title': 'Fikambanana sy fahafahana',
    'staff.organizations.subtitle': 'Hamarino ny fangatahana fidirana ary omeo tsirairay ny fahafahana.',
    'staff.organizations.status': 'Filaharana',
    'staff.organizations.pending': 'Miandry',
    'staff.organizations.approved': 'Nekena',
    'staff.organizations.rejected': 'Nolavina',
    'staff.organizations.empty': 'Tsy misy fangatahana amin’ity sata ity.',
    'staff.organizations.contact': 'Mpifandray',
    'staff.organizations.documents': 'Taratasy',
    'staff.organizations.openDocument': 'Sokafy vetivety',
    'staff.organizations.documentError': 'Tsy afaka nosokafana ilay taratasy.',
    'staff.organizations.createdAt': 'Voaray ny',
    'staff.organizations.details': 'Antsipirihan’ny fangatahana',
    'staff.organizations.approve': 'Ekeo ary mamorona ny fikambanana',
    'staff.organizations.reject': 'Lavina ny fangatahana',
    'staff.organizations.rejectReason': 'Antony fandavana',
    'staff.organizations.rejectReasonPlaceholder': 'Hazavao amin’ny mpangataka ny fanapahan-kevitra…',
    'staff.organizations.confirmReject': 'Hamafiso ny fandavana',
    'staff.organizations.cancel': 'Ajanony',
    'staff.organizations.capabilities': 'Fahafahan’ny fikambanana',
    'staff.organizations.capabilitiesHint': 'Misaraka ny fahafahana tsirairay. Mety hampiato ny fizotry ny fampiasana azy ny fanesorana.',
    'staff.organizations.certify': 'Hanamarina affiliations',
    'staff.organizations.publish': 'Hamoaka antso ho an’ny kandidà',
    'staff.organizations.recruit': 'Hitady tetikasa sy talenta',
    'staff.organizations.mvpOnly': 'V2 — tsy azo ampiasaina amin’ny MVP',
    'staff.organizations.grant': 'Alefa',
    'staff.organizations.revoke': 'Esorina',
    'staff.organizations.success': 'Voarakitra sy voa-audit ny fanapahan-kevitra.',
    'staff.organizations.error': 'Tsy voatsabo ny fangatahana.',
    'staff.organizations.capabilityError': 'Tsy novaina ny fahafahana.',
    'partner.projects.back': 'Hiverina any amin’ny sehatry ny fikambanana',
    'partner.projects.eyebrow': 'SEHATRA HO AN’NY MPIARA-MIASA',
    'partner.projects.title': 'Hitady tetikasa',
    'partner.projects.subtitle': 'Sivano ireo tetikasa mitady olona ary tehirizo manokana ireo hevitrao.',
    'partner.projects.search': 'Hitady',
    'partner.projects.searchPlaceholder': 'Lohateny na olana…',
    'partner.projects.minMaturity': 'Maturity kely indrindra',
    'partner.projects.maxMaturity': 'Maturity ambony indrindra',
    'partner.projects.submit': 'Ampiharo ny sivana',
    'partner.projects.empty': 'Tsy misy tetikasa mifanaraka amin’ireto sivana ireto.',
    'partner.projects.maturity': 'Maturity BMC',
    'partner.projects.watch': 'Araho',
    'partner.projects.unwatch': 'Atsaharo ny fanarahana',
    'partner.projects.notePlaceholder': 'Fanamarihana manokana…',
    'partner.projects.contact': 'Hifandray amin’ny ekipa',
    'partner.projects.contactPlaceholder': 'Lazao fohifohy ny fahaliananao…',
    'partner.projects.sendContact': 'Alefaso ny hafatra',
    'partner.projects.contactSent': 'Voaray ny hafatra. Tsy afaka mandefa hafatra faharoa ianao.',
    'partner.projects.error': 'Tsy tanteraka ity hetsika ity.',
    'partner.profile.title': 'Mombamomba fikambanana voamarina',
    'partner.profile.back': 'Hiverina amin’ny tetikasa',
    'partner.opportunities.back': 'Hiverina any amin’ny sehatry ny fikambanana',
    'partner.opportunities.title': 'Fahafahana',
    'partner.opportunities.subtitle': 'Mamoaha antso ary araho ny fangatahana voaray.',
    'partner.opportunities.create': 'Mamorona fahafahana',
    'partner.opportunities.titlePlaceholder': 'Lohatenin’ny antso',
    'partner.opportunities.descriptionPlaceholder': 'Farito ny filàna, ny fepetra ary ny fizotrany…',
    'partner.opportunities.publish': 'Avoahy',
    'partner.opportunities.draft': 'Drafitra',
    'partner.opportunities.published': 'Navoaka',
    'partner.opportunities.application': 'Fangatahana',
    'partner.opportunities.accept': 'Ekeo',
    'partner.opportunities.reject': 'Lavina',
    'partner.opportunities.rejectPlaceholder': 'Antony fandavana…',
    'partner.talents.back': 'Hiverina any amin’ny sehatry ny fikambanana',
    'partner.talents.title': 'Mitady talenta',
    'partner.talents.subtitle': 'Jereo ireo profil izay nisafidy ny ho hitan’ny mpiara-miasa.',
    'partner.talents.searchPlaceholder': 'Pseudonyme, fahaiza-manao na bio…',
    'partner.talents.search': 'Hitady talenta',
    'partner.talents.empty': 'Tsy misy profil hita mifanaraka amin’ny fikarohanao.',
    'partner.talents.contact': 'Hanolotra fifanakalozana',
    'partner.finance.title': 'Fanohanana ara-bola',
    'partner.finance.create': 'Hanolotra fanohanana',
    'partner.finance.amount': 'Vola',
    'partner.finance.currency': 'Sandam-bola',
    'partner.finance.status': 'Sata : naroso',
    },} as const;
