...
const messages = {
  fr: {
    ...
    'auth.login.email': 'Adresse email universitaire',
    'auth.login.emailPlaceholder': 'nom@etablissement.mg',
    ...
    'auth.login.noAccountHint': 'Les accès sont réservés aux étudiants et alumni d’établissements partenaires.',
  ...
  mg: {
    ...
    'auth.login.email': 'Adiresy mailaka an’ny oniversite',
    'auth.login.emailPlaceholder': 'anarana@sekoly.mg',
