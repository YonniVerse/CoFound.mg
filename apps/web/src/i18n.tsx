...
const messages = {
  fr: {
    ...
    'landing.hero.titleLead': 'Ne cherche pas une idée.',
    'landing.hero.titleAccent': 'Trouve ton Co-fondateur.',
    'landing.hero.body': "L'algorithme de CoFound.mg n'associe pas les profils similaires. Il connecte la rigueur technique du codeur avec la vision stratégique du marketeur.",
    'landing.features.eyebrow': 'Tout ce dont vous avez besoin',
    'landing.features.title': 'Les outils pour réussir',
    'landing.features.body': "Une plateforme pensée pour faciliter les rencontres et accélérer vos premiers pas d'entrepreneurs.",
    'landing.how.eyebrow': 'Le Pipeline CoFound',
    'landing.how.title': "Du profil solo à la startup prête pour l'incubation",
    'landing.forWho.eyebrow': 'La loi de la complémentarité',
    'landing.forWho.title': 'Peu importe ta formation, ta pièce manquante est ici.',
    ...
    'landing.inclusion.statLabel': 'Des fondateurs en Afrique sont des femmes.',
    'landing.inclusion.manifesto': '« Nous refusons de reproduire les mêmes biais à Madagascar. CoFound supprime les barrières structurelles invisibles dès le premier jour. »',
    ...
    'landing.testimonials.body': 'Ils ont rencontré leur moitié business ou technique sur la plateforme.',
    ...
    'landing.steps.step-1.description': 'Décris tes compétences, ce que tu apportes, et ce que tu cherches.',
    'landing.steps.step-2.title': 'Explore ou publie',
    'landing.steps.step-2.description': 'Publie ton projet ou parcours les profils complémentaires au tien.',
    'landing.steps.step-3.title': 'Lance avec ton équipe',
    'landing.steps.step-3.description': 'Connecte-toi avec tes co-fondateurs et démarrez votre aventure.',
    ...
    'landing.features.feat-1.description': "L'algorithme vous suggère des profils qui complètent vos compétences pour former des équipes équilibrées.",
    'landing.features.feat-2.title': 'Messagerie Intégrée',
    'landing.features.feat-2.description': 'Prenez contact en un clic et commencez à discuter de votre vision avec vos potentiels co-fondateurs.',
    'landing.features.feat-3.title': 'Espaces Projets',
    'landing.features.feat-3.description': 'Publiez votre idée de startup pour attirer les talents ou parcourez les projets qui recrutent.',
    'landing.features.feat-4.title': 'Tableau de Bord Parité',
    'landing.features.feat-4.description': "Suivez en temps réel les statistiques d'inclusion et l'impact de la plateforme sur l'écosystème étudiant.",
    'landing.inclusion.inclusion-1.title': 'Espace Sécurisé',
    'landing.inclusion.inclusion-1.description': 'Les étudiantes peuvent rendre leur profil visible uniquement aux femmes dans un premier temps, et candidater en mode anonyme.',
    'landing.inclusion.inclusion-2.title': 'Réseau de Mentores',
    'landing.inclusion.inclusion-2.description': 'Des entrepreneures malgaches établies sont accessibles aux équipes comptant au moins une femme fondatrice.',
    'landing.inclusion.inclusion-3.title': 'Tableau de Bord Parité',
    'landing.inclusion.inclusion-3.description': 'La parité rendue visible en temps réel. Rendre visible crée une pression positive et une fierté collective.',
    'landing.testimonials.testimonial-1.quote': "J'avais l'idée, il me manquait le dev. Trouvé Hery en 2 jours. On a lancé notre app agricole 3 mois après.",
    'landing.testimonials.testimonial-1.field': 'Gestion',
    'landing.testimonials.testimonial-2.quote': "En tant que développeur, je pensais que vendre c'était pas mon truc. Mon co-fondateur trouvé sur CoFound m'a prouvé que ça marchait autrement.",
    'landing.testimonials.testimonial-2.field': 'Informatique',
    'landing.testimonials.testimonial-3.quote': "L'espace femmes m'a aidée à oser. J'ai rejoint un projet HealthTech en candidatant anonymement. Maintenant je suis CTO.",
  ...
  mg: {
    ...
    'auth.login.hero.cardCommunityMeta': 'Talenta · mpiara-manorina · fiantraikany',
    ...
    'landing.hero.titleLead': 'Aza mitady hevitra fotsiny.',
    'landing.hero.titleAccent': 'Tadiavo ny mpiara-mpanorina anao.',
    'landing.hero.body': 'Ny algorithman’ny CoFound.mg dia mampifandray ny fahaiza-manao ara-teknikan’ny mpandrindra kaody amin’ny fahitana stratejikan’ny mpandraharaha.',
    'landing.features.eyebrow': 'Izay rehetra ilainao',
    'landing.features.title': 'Ireo fitaovana hahombiazana',
    'landing.features.body': 'Sehatra natao hanamora ny fihaonana sy hanafaingana ny dingana voalohany amin’ny maha-mpandraharaha.',
    'landing.how.eyebrow': 'Ny Pipeline CoFound',
    'landing.how.title': 'Avy amin’ny profil tokana mankany amin’ny startup vonona hiroborobo',
    'landing.forWho.eyebrow': 'Ny herin’ny fifamenoana',
    'landing.forWho.title': 'Na inona na inona fianaranao, eto ny ampahany tsy ampy aminao.',
    ...
    'landing.inclusion.manifesto': '« Tsy manaiky hamerina ireo fitongilanana mitovy eto Madagasikara izahay. CoFound manala ireo sakana tsy hita maso hatrany am-piandohana. »',
    ...
    'landing.testimonials.body': 'Nahita ny mpiara-miasa ara-barotra na ara-teknika tao amin’ny sehatra izy ireo.',
    ...
    'landing.steps.step-1.description': 'Lazao ny fahaizanao, izay entinao, ary izay tadiavinao.',
    'landing.steps.step-2.title': 'Mikaroka na mamoaka',
    'landing.steps.step-2.description': 'Avoahy ny tetikasanao na tadiavo ireo profil mifameno aminao.',
    'landing.steps.step-3.title': 'Atombohy miaraka amin’ny ekipanao',
    'landing.steps.step-3.description': 'Mifandraisa amin’ireo mpiara-mpanorinao ary atombohy ny dianareo.',
    ...
    'landing.features.feat-1.description': 'Ny algorithma dia manolotra profil mameno ny fahaizanao mba hamoronana ekipa voalanjalanja.',
    'landing.features.feat-2.title': 'Hafatra tafiditra',
    'landing.features.feat-2.description': 'Mifandraisa amin’ny tsindry iray ary resaho ny fahitanao miaraka amin’ireo mety ho mpiara-mpanorina.',
    'landing.features.feat-3.title': 'Toeran’ny tetikasa',
    'landing.features.feat-3.description': 'Avoahy ny hevitrao hanintonana talenta na tadiavo ireo tetikasa mitady ekipa.',
    'landing.features.feat-4.title': 'Tabilao fitovian-jo',
    'landing.features.feat-4.description': 'Araho mivantana ny antontan’isa momba ny fampidirana sy ny fiantraikan’ny sehatra amin’ny tontolon’ny mpianatra.',
    'landing.inclusion.inclusion-1.title': 'Toerana azo antoka',
    'landing.inclusion.inclusion-1.description': 'Afaka asehon’ny mpianatra vehivavy amin’ny vehivavy ihany aloha ny profil-ny ary afaka mangataka amin’ny fomba tsy mitonona anarana.',
    'landing.inclusion.inclusion-2.title': 'Tambajotran’ny mpanoro hevitra vehivavy',
    'landing.inclusion.inclusion-2.description': 'Ireo mpandraharaha vehivavy malagasy efa miorina dia afaka manampy ekipa misy vehivavy mpanorina.',
    'landing.inclusion.inclusion-3.title': 'Tabilao fitovian-jo',
    'landing.inclusion.inclusion-3.description': 'Aseho mivantana ny fitovian-jo. Ny fahitana izany dia mamorona fanerena tsara sy rehareha iombonana.',
    'landing.testimonials.testimonial-1.quote': 'Nanana hevitra aho, fa nila dev. Hery no hitako tao anatin’ny 2 andro. Natombokay 3 volana tatỳ aoriana ny app momba ny fambolena.',
    'landing.testimonials.testimonial-1.field': 'Fitantanana',
    'landing.testimonials.testimonial-2.quote': 'Amin’ny maha-mpandrindra kaody ahy, noheveriko fa tsy ho ahy ny fivarotana. Nasehon’ny mpiara-mpanorina hitako tao CoFound fa azo atao amin’ny fomba hafa izany.',
    'landing.testimonials.testimonial-2.field': 'Informatika',
    'landing.testimonials.testimonial-3.quote': 'Nanampy ahy ho sahy ny toerana ho an’ny vehivavy. Niditra tamin’ny tetikasa HealthTech aho tamin’ny fangatahana tsy mitonona anarana. Ankehitriny aho CTO.',
    'landing.testimonials.testimonial-3.field': 'Design',
