...
const messages = {
  fr: {
    ...
    'settings.export.description': 'La préparation est asynchrone. Vous recevrez une notification lorsque votre archive sera prête, avec un lien de téléchargement temporaire.',
    'settings.export.request': 'Demander mon export',
  ...
  mg: {
    ...
    'settings.export.title': 'Avoahy ny angon-drakitra manokana',
    'settings.export.description': 'Atao tsikelikely ny fanomanana. Hahazo fampandrenesana ianao rehefa vonona ny rakitra, miaraka amin’ny rohy fampidinana vonjimaika.',
    'settings.export.request': 'Hangataka ny fanondranana',
    'settings.export.pending': 'Eo am-panomanana…',
    'settings.export.status': 'Toetry ny fangatahana',
